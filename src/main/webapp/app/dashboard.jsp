...
<main class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-xl-3"><div class="card dashboard-card soft-panel h-100"><div class="card-body p-4"><span class="text-accent fs-4">⌂</span><h2 class="h5 mt-3">Propiedades</h2><p class="text-secondary">Consulta el catálogo y encuentra oportunidades disponibles.</p><a class="btn btn-sm btn-accent" href="<%= request.getContextPath() %>/propiedades">Ver propiedades</a><a class="btn btn-sm btn-outline-dark ms-1" href="<%= request.getContextPath() %>/app/favoritos">Favoritos</a></div></div></div>
