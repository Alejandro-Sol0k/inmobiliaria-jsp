...
<main class="container py-5">
    ...
    <form action="<%= request.getContextPath() %>/propiedades" method="get" class="card filter-panel border-0 shadow-sm p-3 p-lg-4 mb-5">
        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-2"><label class="form-label" for="precioMaxVisible">Precio máximo</label><div class="input-group money-field"><span class="input-group-text">$</span><input class="form-control" id="precioMaxVisible" data-money-input="precioMax" inputmode="numeric" value="<%= filtroPrecioMax == null ? "" : filtroPrecioMax %>" placeholder="Ej. 500.000.000"><input type="hidden" name="precioMax" data-money-value="precioMax" value="<%= filtroPrecioMax == null ? "" : filtroPrecioMax %>"></div></div>
