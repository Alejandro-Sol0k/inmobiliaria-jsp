            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="hero-card rounded-4 p-4 shadow-lg">
                        ...
                        <form action="<%= request.getContextPath() %>/propiedades.jsp" method="post" class="row g-3">
                ...
                <div class="col-md-4">
                    <article class="card property-card h-100 border-0 shadow-sm overflow-hidden">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <form action="<%= request.getContextPath() %>/propiedad.jsp" method="post" class="mt-auto"><input type="hidden" name="id" value="<%= propiedad.getId() %>"><button class="btn btn-accent btn-sm w-100" type="submit">Ver detalle</button></form>
                        </div>
                    </article>
                </div>
            <%   }
